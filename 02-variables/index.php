...
<body>
    ...
    */
    ...
    dump(strval($v));    // Transforme une variable en chaîne
    dump(intval($v));    // Retourne la valeur numérique entière équivalente d'une variable
    dump(floatval($v));  // Convertit une chaîne en nombre à virgule flottante
    dump(boolval($v));   // Récupère la valeur booléenne d'une variable
    dump(number_format($v, 2, ',', ' ')); // Formate un nombre pour l'affichages
    echo "</pre>";
    */
